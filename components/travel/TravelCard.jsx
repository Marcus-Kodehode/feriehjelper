...
export default function TravelCard({ trip, isNextTrip, defaultOpen = true, onEdit }) {
  ...
  // Robust sammenligning: hvis tid mangler, bruk 23:59
    ...
    <div className="relative rounded-lg shadow-lg mb-4 border border-contrast bg-[#1f1f1f] text-footerText overflow-hidden">
      ...
      <div className="flex items-center justify-between gap-3 px-4 py-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Samme stil som budsjett-/aktivitet-/nød-kort */}
      ...
      {open && (
        <div id={cardBodyId} className="px-4 pb-4">
          <div className="flex flex-col justify-between gap-4 sm:flex-row">
            ...
            {/* Høyre kolonne ble brukt til delete-knapp før – fjernet for å unngå duplikat */}
          </div>
        </div>
      )}
