        ...
        <div className="flex flex-col flex-1 gap-2">
          ...
          {budsjett && (
            <div className="mt-3 p-3 bg-[#2a2a2a] border border-yellow-500 rounded-md space-y-1">
              ...
              <p className="text-sm text-gray-300">Total: {budsjett.amount} {currency}</p>
              {budsjett.daily && (
                <p className="text-sm text-gray-300">Daglig: {budsjett.daily} {currency}</p>
              )}
              {budsjett.transport && (
                <p className="text-sm text-gray-300">Transport: {budsjett.transport} {currency}</p>
              )}
              {budsjett.accommodation && (
                <p className="text-sm text-gray-300">Hotell: {budsjett.accommodation} {currency}</p>
              )}
              {budsjett.food && (
                <p className="text-sm text-gray-300">Mat: {budsjett.food} {currency}</p>
              )}
              {budsjett.activities && (
                <p className="text-sm text-gray-300">Aktiviteter: {budsjett.activities} {currency}</p>
              )}
              {budsjett.misc && (
                <p className="text-sm text-gray-300">Annet: {budsjett.misc} {currency}</p>
              )}
              {budsjett.notes && (
          ...
          {nextActivity && (
            <div className="mt-3 p-3 bg-[#2a2a2a] border border-green-500 rounded-md space-y-1">
              <p className="text-sm font-bold text-green-300">Neste aktivitet</p>
              ...
              {nextActivity.place && (
                <p className="text-sm text-gray-300">Sted: {nextActivity.place}</p>
              )}
            </div>
          )}
          ...
          {emergency && (
            <div className="mt-3 p-3 bg-[#2a2a2a] border border-red-500 rounded-md space-y-1">
              <p className="text-sm font-bold text-red-400">Nødinformasjon</p>
